...
var miscSubs = []TxnSubcategory{
	...
	{ID: "misc-loss", Name: "Lost/Stolen", CatID: "misc", Hint: "money lost, stolen, pickpocketed, snatched, damaged item; income side when the money was taken from someone else"},
...
var subKeywords = map[string]string{
	...
	"misc-loss":   "lost, stolen, theft, snatched, snatch, snached, robbed, mugged, pickpocket, chinatai, chhinatai",
	"misc-adj":    "adjustment, correction",
